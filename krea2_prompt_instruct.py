...
def _refresh_llama_cache_if_needed(llama_model):
    ...
    if current_llm is not None and current_config != llama_model:
        print("[WenWu Krea2] llama model config changed, refreshing cached llama-cpp model.")
